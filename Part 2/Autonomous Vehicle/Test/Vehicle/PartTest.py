...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self._wheel = Part(1, "Wheel", Colour(255, 255, 255), "Audi", {"Diameter": 3, "Radius": 10})
    ...
    def testValueErrorIsRaisedIfThePartHasNoName(self):
        ...
        with self.assertRaises(ValueError):
            self._wheel = Part(1, "", Colour(255, 255, 255), "Audi", {"Diameter": 3, "Radius": 10})

    def testValueErrorIsRaisedIfThePartHasNoManufacture(self):
        """Testing a value error is raised if the part has no manufacture"""
        with self.assertRaises(ValueError):
            self._wheel = Part(1, "Wheel", Colour(255, 255, 255), "", {"Diameter": 3, "Radius": 10})
    ...
    def testPartNameSetter(self):
        ...
        self._wheel = Part(1, "Engine", Colour(255, 255, 255), "Audi", {"Diameter": 3, "Radius": 10})
        self._wheel.name = "Wheel"
        self.assertEqual(self._wheel.name, "Wheel")

    def testValueErrorIsRaisedIfYouSetThePartNameAsAnEmptyStringUsingThePartNameSetter(self):
        """Testing a value error is raised if the part name has no name"""
        with self.assertRaises(ValueError):
            self._wheel.name = ""
    ...
    def testPartObject(self):
        """Testing the part object"""
