...
class Trunk(Part):
    ...
    def __init__(self, part_id: int, name: str, colour: Colour, manufacturer: str, dimensions: dict[str, float],
                 closed: bool, locked: bool) -> None:
        """
        Constructor for the trunk object
        :parameter Trunk self: The trunk object
        ...
        :returns: None
        """
        # The Trunk class inherits from the part class so uses the parent class constructor.
        ...
        self._closed = closed
        # Door can't be locked unless its shut
    ...
    def __str__(self) -> str:
        ...
        :returns: A door object as a string
        """
        door_shut = f'Trunk Shut' if self._closed else "Trunk Open"
        door_locked = f'Trunk Locked' if self._locked else "Trunk Unlocked"
