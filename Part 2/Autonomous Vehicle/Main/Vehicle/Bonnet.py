...
class Bonnet(Part):
    ...
    def __init__(self, part_id: int, name: str, colour: Colour, manufacturer: str, dimensions: dict[str, float])\
            -> None:
        """
        Constructor for the bonnet object
        :parameter Bonnet self: The bonnet object
        ...
        :returns: None
        """
        # The bonnet class inherits from the part class so uses the parent class constructor.
