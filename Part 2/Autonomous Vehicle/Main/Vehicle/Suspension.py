...
class Suspension(Part):
    ...
    def __init__(self, part_id: int, name: str, colour: Colour, manufacturer: str, dimensions: dict[str, float]) \
            -> None:
        """
        Constructor for the suspension object
        :parameter Suspension self: The suspension object
        ...
        :returns: None
        """
        # The suspensions class inherits from the part class so uses the parent class constructor.
